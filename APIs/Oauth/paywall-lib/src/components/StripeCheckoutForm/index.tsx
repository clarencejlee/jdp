...
// TODO: Create a prop that takes a logo url
// and displays it if its present in the stripe checkout form
...
export const Field = ({
  ...
  <div className={isStripe ? 'FormRow' : ''}>
    <label htmlFor={id} className={isStripe ? 'FormRowLabel' : ''}>
      {label}
    </label>
    <input
      className={isStripe ? 'FormRowInput' : ''}
      id={id}
      type={type}
      ...
      {subscribed ? (
        ...
        <div>
          ...
          <div className="ResultMessage">
            Thank you for your purchase. You have gained access to our premium
            features!
            <br />
